...
class DDQNAgent:
    ...
    def initialize_ddqn(self):
        ...
        self.target_ddqn = DDQN(network_input.shape[1], output_size).to(self.device)
    ...
    def load_model(self):
        ...
        self.target_ddqn.load_state_dict(torch.load(self.filepath, map_location=self.device))
