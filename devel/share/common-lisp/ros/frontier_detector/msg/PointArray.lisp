...
(cl:defmethod cl:initialize-instance :after ((m <PointArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PointArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name frontier_detector-msg:<PointArray> is deprecated: use frontier_detector-msg:PointArray instead.")))

(cl:ensure-generic-function 'points-val :lambda-list '(m))
(cl:defmethod points-val ((m <PointArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader frontier_detector-msg:points-val is deprecated.  Use frontier_detector-msg:points instead.")
  (points m))
